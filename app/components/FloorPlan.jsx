    ...
    <section className="bg-gradient-to-b from-[#EAE1D5] to-[#EAE1D5] py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <div className="grid gap-8 mb-12 align-center">
            {/* Home Area Card */}
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-[#96694d]/70 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-[#EAE1D5]/20 hover:border-[#EAE1D5]/50 transition-all duration-300"
            >
